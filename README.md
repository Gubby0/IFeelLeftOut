...
Navigate to the steam workshop page to install. Open Puck and enable the mod via the in-game tool.

When you are either Blue or Red goalie, pressing F1 will change your camera to the view of the opposing offensive zone.


.\upload.ps1 -Public -ChangeNote "Version 2.1 - Enhanced stability"